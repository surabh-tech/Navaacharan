    ...
    <div class="push-menu push-menu-style-2 ps-50px pe-50px pt-4 pb-4 bg-white">
        ...
        <div class="push-menu-wrapper" data-scroll-options='{ "theme": "dark" }'>
            <div class="push-menu-header pt-10 pb-30 mb-30 d-block">
                <h4 class="alt-font fw-500 text-white lh-42">Scalable tech solutions for <span class="text-decoration-line-bottom-medium fw-700">all domains</span></h4>
            </div>
            ...
            <div class="push-menu-social last-paragraph-no-margin">
                ...
                <p class="fs-14">&COPY; Copyright 2024 <a href="index.html" target="_blank">Navaacharan</a></p>
            </div>
        </div>
    </div>
    <!-- end push popup -->
